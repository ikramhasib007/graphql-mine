import { DhakaNorthAreas, DhakaSouthAreas } from "./dccAreas"
...
export const USER_TYPES = [
	{
		...
		"value": {
			userType: "MODARATOR",
			permissions: getUserPermissions("MODARATOR")
		}
	},
	{
		"label": "Editor",
		"value": {
			userType: "EDITOR",
			permissions: getUserPermissions("EDITOR")
		}
	},
	{
		"label": "User",
	...
	},
	{
		...
		"value": {
			userType: "MERCHANT",
			permissions: getUserPermissions("MERCHANT")
		}
	},
	{
		...
		"value": {
			...
			permissions: getUserPermissions("CUSTOMER_SUPPORT")
		}
	},
	{
		"label": "Acquisition Executive",
		"value": {
			userType: "ACQUISITION_EXECUTIVE",
			permissions: getUserPermissions("ACQUISITION_EXECUTIVE")
		}
	},
]

export const SHOP_TYPES = [{ label: 'Retail', value: 'RETAIL' }, { label: 'Warehouse', value: 'WAREHOUSE' }]

export const PAYMENT_STATUS_OPTIONS = [
	{ label: 'Pending', value: { title: 'Pending', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Paid', value: { title: 'Paid', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Refunded', value: { title: 'Refunded', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Canceled', value: { title: 'Canceled', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Abandoned', value: { title: 'Abandoned', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Overdue', value: { title: 'Overdue', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'In Dispute', value: { title: 'In Dispute', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Awaiting Gateway', value: { title: 'Awaiting Gateway', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Failed Gateway', value: { title: 'Failed Gateway', color: '#1f2937', bgColor: '#f1f5f9' }},
]

export const BILLING_STATUS_OPTIONS = [
	{ label: 'New', value: { title: 'New', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Pending', value: { title: 'Pending', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Paid', value: { title: 'Paid', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Refunded', value: { title: 'Refunded', color: '#1f2937', bgColor: '#f1f5f9' }},
	{ label: 'Canceled', value: { title: 'Canceled', color: '#1f2937', bgColor: '#f1f5f9' }},
...
export const STATUS_TEXT = [
	...
	{ label: 'Awaiting Gateway', value: 'Awaiting Gateway' },
	{ label: 'Failed Gateway', value: 'Failed Gateway' },
]
...
export const DISTRICT_LIST = [
	{"id":"1","division_id":"1","name":"Cumilla","bn_name":"কুমিল্লা","lat":"23.4682747","lon":"91.1788135","url":"www.comilla.gov.bd"},
	...
	{"id":"47","division_id":"6","name":"Dhaka - North","bn_name":"ঢাকা - উত্তর","lat":"23.7115253","lon":"90.4111451","url":"www.dhaka.gov.bd"},
	...
	{"id":"65","division_id":"6","name":"Dhaka - South","bn_name":"ঢাকা - দক্ষিণ","lat":"23.7115253","lon":"90.4111451","url":"www.dhaka.gov.bd"},
]

export const UPAZILLA_LIST = [
...
export function GetDivisionList() {
	return DIVISION_LIST.map(item => ({ label: item.name, value: item })).sort((a, b) => a.label.localeCompare(b.label))
}

export function GetDistrictList(division_id) {
	let list;
	if(division_id) list = DISTRICT_LIST.filter(item => item.division_id === division_id)
	else list = DISTRICT_LIST
	return list.map(item => ({ label: item.name, value: item })).sort((a, b) => a.label.localeCompare(b.label))
}

export function GetUpazillaList(district_id) {
	const list = UPAZILLA_LIST.filter(item => item.district_id === district_id)
	return list.map(item => ({ label: item.name, value: item })).sort((a, b) => a.label.localeCompare(b.label))
}
